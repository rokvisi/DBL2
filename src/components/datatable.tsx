    ...
    <>
      {insertable && (
        <Link href={`/${table}/insert`} passHref>
          <a className="inline-block p-2 mb-5 bg-gray-400 rounded hover:bg-gray-300">+ Pridėti naują</a>
        </Link>
      )}
      <table className="w-full max-w-full">
        <thead className="font-medium text-left text-gray-700 border-b border-black">
          <tr>
